...
<div class="about">
    ...
    <div class="projetos-info">
        <div class="container">
            <a href="index.php">Home/</a><h2>Projetos</h2>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="section-title">
                        <h1 style="color:black">Nosssos Projetos</h1>
                        <br>
                        <br>
                        <h4 style="color:black">Conheça um pouco dos nossos projetos. Agende uma visita</h4>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-0-gutter">
                    <div class="ot-portfolio-item">
                        <figure class="effect-bubba">
                            <img src="{{asset($registro->imagem1)}}" alt="img02" class="img-responsive" />
                            <figcaption id="slideeeee">
                                <h2>{{$registro->titulo}}</h2>
                                <p>{{$registro->descricao}}</p>
                                     <a href="{{route('menu.slide', $registro->id)}}" data-toggle="modal" data-target="#Modal-1">View more</a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
...
<div class="modal fade" id="Modal-1" tabindex="-1" role="dialog" aria-labelledby="Modal-label-1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div id="conteudo" style="width: 100%;height:100%;"></div>
        </div>
    </div>
</div>
