                        ...
                        <div class="form">
                            <form class="form-validate form-horizontal " id="register_form" method="post" action="{{ route('admin.atualizar.projeto', $registro->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class=" form-control" id="address" name="imagem1" type="file" value="{{$registro->imagem1}}"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class=" form-control" id="address" name="imagem2" type="file" value="{{$registro->imagem2}}"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class=" form-control" id="address" name="imagem3" type="file" value="{{$registro->imagem3}}"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class=" form-control" id="address" name="imagem4" type="file" value="{{$registro->imagem4}}"/>
                                    </div>
                                </div>
